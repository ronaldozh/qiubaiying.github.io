...
![](http://p3csbnxye.bkt.clouddn.com/javase19_1.jpg)
+ 增加元素方法
...
+ 链表，采用该结构的集合，对元素的存取有如下的特点：	
	...
	+ 增删元素快：
		...
		![](http://p3csbnxye.bkt.clouddn.com/javase19_5.jpg)
...
![](http://p3csbnxye.bkt.clouddn.com/javase19_6.jpg)  
...
+ Vector常见的方法：
![](http://p3csbnxye.bkt.clouddn.com/javase19_7.jpg)  
+ Enumeration枚举常见的方法：
![](http://p3csbnxye.bkt.clouddn.com/javase19_8.jpg) 
+ Vector集合对ArrayList集合使用的对比
![](http://p3csbnxye.bkt.clouddn.com/javase19_9.jpg) 
...
![](http://p3csbnxye.bkt.clouddn.com/javase19_10.jpg)
...
![](http://p3csbnxye.bkt.clouddn.com/javase19_11.jpg)
...
![](http://p3csbnxye.bkt.clouddn.com/javase19_12.jpg)
...
所以，使用HashSet存储自定义类型，如果没有重写该类的hashCode与equals方法，则判断重复时，使用的是地址值，
