...
8种基本类型对应的包装类如下：
![](http://p3csbnxye.bkt.clouddn.com/javase17_1.jpg)
其中需要注意int对应的是Integer，char对应的Character，其他6个都是基本类型首字母大写即可。  
基本数据类型对象包装类特点：用于在基本数据和字符串之间进行转换。
+ 将字符串转成基本类型：
![](http://p3csbnxye.bkt.clouddn.com/javase17_2.jpg)
...
+ 将基本数值转成字符串有3种方式：
	...
	![](http://p3csbnxye.bkt.clouddn.com/javase17_3.jpg)
	+ 调用包装类中的toString方法；Integer.toString(34) ；
	![](http://p3csbnxye.bkt.clouddn.com/javase17_4.jpg)
	
#### 1.2 基本类型和对象转换	

使用int类型与Integer对象转换进行演示，其他基本类型转换方式相同。
+ 基本数值---->包装对象
![](http://p3csbnxye.bkt.clouddn.com/javase17_5.jpg)
```
Integer i = new Integer(4);//使用构造函数函数
Integer ii = new Integer("4");//构造函数中可以传递一个数字字符串
```
![](http://p3csbnxye.bkt.clouddn.com/javase17_6.jpg)
```
Integer iii = Integer.valueOf(4);//使用包装类中的valueOf方法
Integer iiii = Integer.valueOf("4");//使用包装类中的valueOf方法
```
+ 包装对象---->基本数值
![](http://p3csbnxye.bkt.clouddn.com/javase17_7.jpg)
```
int num = i.intValue();
```
...
![](http://p3csbnxye.bkt.clouddn.com/javase17_8.jpg)
...
![](http://p3csbnxye.bkt.clouddn.com/javase17_9.png)
+ arraycopy方法，用来实现将源数组部分元素复制到目标数组的指定位置
![](http://p3csbnxye.bkt.clouddn.com/javase17_10.jpg)
...
![](http://p3csbnxye.bkt.clouddn.com/javase17_11.jpg)
+ abs方法,结果都为正数
```
...
![](http://p3csbnxye.bkt.clouddn.com/javase17_12.jpg)
...
BigInteger类的构造方法:
![](http://p3csbnxye.bkt.clouddn.com/javase17_13.jpg)
构造方法中,采用字符串的形式给出整数  
四则运算代码：
```
public static void main(String[] args) {
...
构造方法如下:
![](http://p3csbnxye.bkt.clouddn.com/javase17_14.jpg)
...
![](http://p3csbnxye.bkt.clouddn.com/javase17_15.jpg)
