...
![](http://p3csbnxye.bkt.clouddn.com/javase15_1.jpg)
...
![](http://p3csbnxye.bkt.clouddn.com/javase15_2.jpg)
...
![](http://p3csbnxye.bkt.clouddn.com/javase15_3.jpg)
...
![](http://p3csbnxye.bkt.clouddn.com/javase15_4.jpg)
```
...
+ 字符串中有多少个字符?
![](http://p3csbnxye.bkt.clouddn.com/javase15_5.jpg)
```
String str = "abcde";
int len = str.length();
...
```
+ 获取部分字符串。
![](http://p3csbnxye.bkt.clouddn.com/javase15_6.jpg)
```
String str = "abcde";
...
+ 字符串是否以指定字符串开头。结尾同理。
![](http://p3csbnxye.bkt.clouddn.com/javase15_7.jpg)
```
...
```
+ 字符串中是否包含另一个字符串。
![](http://p3csbnxye.bkt.clouddn.com/javase15_8.jpg)
```
String str = "abcde";
...
```
+ 将字符串转成一个字符数组。或者字节数组。
![](http://p3csbnxye.bkt.clouddn.com/javase15_9.jpg)
```
String str = "abcde";
...
```
+ 判断两个字符串中的内容是否相同
![](http://p3csbnxye.bkt.clouddn.com/javase15_10.jpg)
```
String str = "abcde";
String str2 = "abcde";
String str3 = "hello";
...
```
+ 获取该字符串对象中的内容
![](http://p3csbnxye.bkt.clouddn.com/javase15_11.jpg)
```
...
![](http://p3csbnxye.bkt.clouddn.com/javase15_12.jpg)
+ 代码演示：
```
创建一个字符串缓冲区对象。用于存储数据。
