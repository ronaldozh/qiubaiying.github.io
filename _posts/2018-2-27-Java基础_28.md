...
+ 数据库与数据库管理系统的关系
![](http://p1tx4k6f5.bkt.clouddn.com/javase28_1.jpg)
...
![](http://p1tx4k6f5.bkt.clouddn.com/javase28_2.jpg)
+ 表记录与java类对象的对应关系
![](http://p1tx4k6f5.bkt.clouddn.com/javase28_3.jpg)
...
+ 同样可以使用/**/的方式完成注释
+ MySQL中的我们常使用的数据类型如下
![](http://p1tx4k6f5.bkt.clouddn.com/javase28_4.jpg)
详细的数据类型如下(不建议详细阅读！)
![](http://p1tx4k6f5.bkt.clouddn.com/javase28_5.jpg)
...
```
![](http://p1tx4k6f5.bkt.clouddn.com/javase28_6.jpg)
+ 查看数据库
...
while条件的种类如下：
![](http://p1tx4k6f5.bkt.clouddn.com/javase28_7.jpg)
例如：
```
查询所有吃饭支出记录
