...
![](http://p3csbnxye.bkt.clouddn.com/javase21_1.jpg)  
...
```
+ 上述程序执行过程图解：
![](http://p3csbnxye.bkt.clouddn.com/javase21_5.jpg) 
...
![](http://p3csbnxye.bkt.clouddn.com/javase21_6.jpg) 
...
+ try finally 组合: 对代码进行异常检测，检测到异常后因为没有catch，所以一样会被默认jvm抛出。异常是没有捕获处理的。
但是功能所开启资源需要进行关闭，所有finally。只为关闭资源。
```
void show(){//需要throws 
	try{
	    throw new Exception();
...
![](http://p3csbnxye.bkt.clouddn.com/javase21_7.jpg) 
