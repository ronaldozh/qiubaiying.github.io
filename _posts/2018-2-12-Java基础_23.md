...
![](http://p3csbnxye.bkt.clouddn.com/javase23_1.jpg)

##### 1.1.1	FileOutputStream类

OutputStream有很多子类，其中子类FileOutputStream可用来写入数据到文件。  
FileOutputStream类，即文件输出流，是用于将数据写入 File的输出流。
![](http://p3csbnxye.bkt.clouddn.com/javase23_2.jpg)
![](http://p3csbnxye.bkt.clouddn.com/javase23_3.jpg)
...
+ 构造方法
![](http://p3csbnxye.bkt.clouddn.com/javase23_4.jpg)
+ 给文件中续写数据和换行，代码演示：
```
...
![](http://p3csbnxye.bkt.clouddn.com/javase23_5.jpg)
...
![](http://p3csbnxye.bkt.clouddn.com/javase23_6.jpg)
![](http://p3csbnxye.bkt.clouddn.com/javase23_7.jpg)

##### 1.2.2	FileInputStream类读取数据read方法

在读取文件中的数据时，调用read方法，实现从文件中读取数据
![](http://p3csbnxye.bkt.clouddn.com/javase23_8.jpg)
+ 从文件中读取数据，代码演示：
```
...
![](http://p3csbnxye.bkt.clouddn.com/javase23_9.jpg)
```
...
##### 1.3.1	复制文件
![](http://p3csbnxye.bkt.clouddn.com/javase23_10.jpg)
```
...
![](http://p3csbnxye.bkt.clouddn.com/javase23_11.jpg)
+ read():读取单个字符并返回
...
+ 构造方法
![](http://p3csbnxye.bkt.clouddn.com/javase23_12.jpg)
...
![](http://p3csbnxye.bkt.clouddn.com/javase23_13.jpg)
...
+ 构造方法
![](http://p3csbnxye.bkt.clouddn.com/javase23_14.jpg)
...
![](http://p3csbnxye.bkt.clouddn.com/javase23_15.jpg)
