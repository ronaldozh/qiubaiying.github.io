...
![](http://p3csbnxye.bkt.clouddn.com/javase01_1.jpg)  
...
![](http://p3csbnxye.bkt.clouddn.com/javase01_2.jpg)  
...
![](http://p3csbnxye.bkt.clouddn.com/javase01_3.jpg)

### 2 Hello World案例

#### 2.1 Java程序介绍

![](http://p3csbnxye.bkt.clouddn.com/javase01_4.jpg)
...
![](http://p3csbnxye.bkt.clouddn.com/javase01_5.jpg)  
然后修改文件名称为HelloWorld.java，注意文件名称的大小写。以及是否已经修改了文件的扩展名。
![](http://p3csbnxye.bkt.clouddn.com/javase01_6.jpg)  
如果看不到文件后缀名：
+ win10系统：在文件资源管理器中选择“查看”
![](http://p3csbnxye.bkt.clouddn.com/javase01_8.jpg) 
把“文件扩展名”选项的小框勾选上
![](http://p3csbnxye.bkt.clouddn.com/javase01_9.jpg) 
+ win7系统：通过窗口上方“查看”菜单中的“文件夹选择”找到“查看”选项卡，
在“查看选择卡”的高级设置找到“隐藏已知文件类型的扩展名”选项，去掉前面的勾，点击“确定”即可显示文件后缀名了。如下图
![](http://p3csbnxye.bkt.clouddn.com/javase01_7.jpg) 
...
![](http://p3csbnxye.bkt.clouddn.com/javase01_10.jpg)  
...
![](http://p3csbnxye.bkt.clouddn.com/javase01_11.jpg)   
请注意，在编译时控制台上不会有输出，如果有输出说明源代码有错误，所以大家一旦编译出错，就要去查看源文件中是否存在错误。  
![](http://p3csbnxye.bkt.clouddn.com/javase01_12.jpg)
...
![](http://p3csbnxye.bkt.clouddn.com/javase01_13.jpg)  
...
![](http://p3csbnxye.bkt.clouddn.com/javase01_14.jpg)   
新建一个系统变量，变量名为java_home,变量值为JDK安装目录 
![](http://p3csbnxye.bkt.clouddn.com/javase01_15.jpg)   
查看系统变量中是否存在classpath，若有则修改，若无新建一个系统变量，变量值为.;%java_home%\lib\dt.jar;%java_home%\lib\tools.jar;
![](http://p3csbnxye.bkt.clouddn.com/javase01_17.jpg) 
在系统变量中找到PATH  →  点击编辑按钮。将%java_home%\bin;编辑到PATH中
![](http://p3csbnxye.bkt.clouddn.com/javase01_16.jpg) 
...
![](http://p3csbnxye.bkt.clouddn.com/javase01_18.jpg)
...
![](http://p3csbnxye.bkt.clouddn.com/javase01_19.jpg)  
...
![](http://p3csbnxye.bkt.clouddn.com/javase01_20.jpg)  
