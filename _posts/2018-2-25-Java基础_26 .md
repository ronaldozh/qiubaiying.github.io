...
![](http://p1tx4k6f5.bkt.clouddn.com/Javase26_1.jpg)
线程：线程是进程中的一个执行单元，负责当前进程中程序的执行，一个进程中至少有一个线程。一个进程中是可以有多个线程的，这个应用程序也可以称之为多线程程序。  
简而言之：一个程序运行后至少有一个进程，一个进程中可以包含多个线程
![](http://p1tx4k6f5.bkt.clouddn.com/Javase26_2.jpg)
什么是多线程呢？即就是一个程序中有多个线程在同时执行。  
通过下图来区别单线程程序与多线程程序的不同：  
+ 单线程程序：即，若有多个任务只能依次执行。当上一个任务执行结束后，下一个任务开始执行。
如，去网吧上网，网吧只能让一个人上网，当这个人下机后，下一个人才能上网。
+ 多线程程序：即，若有多个任务可以同时执行。如，去网吧上网，网吧能够让多个人同时上网。
![](http://p1tx4k6f5.bkt.clouddn.com/Javase26_3.jpg)
...
![](http://p1tx4k6f5.bkt.clouddn.com/Javase26_6.jpg)
+ 构造方法
![](http://p1tx4k6f5.bkt.clouddn.com/Javase26_7.jpg)
+ 常用方法
![](http://p1tx4k6f5.bkt.clouddn.com/Javase26_8.jpg)
继续阅读，发现创建新执行线程有两种方法。
...
![](http://p1tx4k6f5.bkt.clouddn.com/Javase26_9.jpg)  
...
既然找到了，我们就可以试试。
![](http://p1tx4k6f5.bkt.clouddn.com/Javase26_10.jpg)  
...
![](http://p1tx4k6f5.bkt.clouddn.com/Javase26_11.jpg) 
+ 接口中的方法
![](http://p1tx4k6f5.bkt.clouddn.com/Javase26_12.jpg) 
+ Thread类构造方法
![](http://p1tx4k6f5.bkt.clouddn.com/Javase26_13.jpg) 
创建线程的步骤：
1. 定义类实现Runnable接口。
2. 覆盖接口中的run方法。。
3. 创建Thread类的对象
...
![](http://p1tx4k6f5.bkt.clouddn.com/Javase26_14.jpg) 
我们详细的解释一下为什么要使用线程池？  
