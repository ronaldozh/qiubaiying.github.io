...
![](http://p2q983f8e.bkt.clouddn.com/importEclipse_1.jpg)
![](http://p2q983f8e.bkt.clouddn.com/importEclipse_2.jpg)
![](http://p2q983f8e.bkt.clouddn.com/importEclipse_3.jpg)
![](http://p2q983f8e.bkt.clouddn.com/importEclipse_4.jpg)
![](http://p2q983f8e.bkt.clouddn.com/importEclipse_5.jpg)
![](http://p2q983f8e.bkt.clouddn.com/importEclipse_6.jpg)
![](http://p2q983f8e.bkt.clouddn.com/importEclipse_7.jpg)
配置服务器
![](http://p2q983f8e.bkt.clouddn.com/importEclipse_8.jpg)
![](http://p2q983f8e.bkt.clouddn.com/importEclipse_9.jpg)

配置spring管理工具
![](http://p2q983f8e.bkt.clouddn.com/importEclipse_10.jpg)
![](http://p2q983f8e.bkt.clouddn.com/importEclipse_11.jpg)
![](http://p2q983f8e.bkt.clouddn.com/importEclipse_12.jpg)
...
+ 统一配置编码方式为UTF-8,（[参考博客](https://blog.csdn.net/fengqing5578/article/details/80648753)）
...
+ 修改选中单词关联的相同单词高亮：Settings->Editor->Color Scheme->General->Identifier under caret,修改背景色
...
+ [添加注释](https://www.jianshu.com/p/09139b425cc3)
+ 在mybatis中，鼠标移到sql语句上会给出提示（不需要的提示）File -> setting 搜索inspections,再搜索sql，找到SQL dialect detection去掉勾，然后apply ->ok
+ 配置生成文件注释：Settings->Editor->File and Code Templates->Class,添加内容即可。[参考博客](https://www.cnblogs.com/godtrue/p/8644121.html)
+ 配置当前文件中内容字体的增大或减小。[滚动鼠标调节配置参考](https://www.cnblogs.com/zlslch/p/7770965.html)
+ 配置整个项目字体大小：Settings->Editor->Font->Size（填写自己需要的大小）
+ 添加alt+/智能感：[参考博客，博客中大小写是旧版本不能用](https://blog.csdn.net/gaoqiao1988/article/details/73299670)
