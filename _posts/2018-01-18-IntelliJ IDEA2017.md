...
+ 鼠标悬停出现提示：Settings->Editor->General->show documentation on mouse move，打钩
+ 去掉编辑区的中竖线：Settings->Editor->General->Appearence->show hard wrap guide(...)，去掉    
+ 修改注释及字体颜色：Settings->Editor->Color Scheme->Java，选择
...
+ 修改Terminal字体大小：Settings->Editor->Color Scheme->Console font->Font，选择Consolas
### 6、IDEA参考文献
