...
![](http://p3csbnxye.bkt.clouddn.com/javase20_1.jpg)
...
![](http://p3csbnxye.bkt.clouddn.com/javase20_2.jpg)
...
![](http://p3csbnxye.bkt.clouddn.com/javase20_3.jpg)
2. 遍历键的Set集合，得到每一个键
3. 根据键，获取键所对应的值
![](http://p3csbnxye.bkt.clouddn.com/javase20_4.jpg)  
代码演示：
```
public class MapDemo {
	public static void main(String[] args) {
...
![](http://p3csbnxye.bkt.clouddn.com/javase20_5.jpg)  
+ Entry是Map接口中提供的一个静态内部嵌套接口。
![](http://p3csbnxye.bkt.clouddn.com/javase20_6.jpg) 
+ getKey()方法：获取Entry对象中的键
+ getValue()方法：获取Entry对象中的值
![](http://p3csbnxye.bkt.clouddn.com/javase20_7.jpg) 
...
![](http://p3csbnxye.bkt.clouddn.com/javase20_8.jpg) 
2. 遍历包含键值对(Entry)对象的Set集合，得到每一个键值对(Entry)对象
3. 通过键值对(Entry)对象，获取Entry对象中的键与值。
![](http://p3csbnxye.bkt.clouddn.com/javase20_9.jpg) 
![](http://p3csbnxye.bkt.clouddn.com/javase20_10.jpg) 
```
public class MapDemo {
	public static void main(String[] args) {
		//创建Map对象
...
![](http://p3csbnxye.bkt.clouddn.com/javase20_11.jpg) 
...
![](http://p3csbnxye.bkt.clouddn.com/javase20_12.jpg)
...
按照斗地主的规则，完成洗牌发牌的动作。
![](http://p3csbnxye.bkt.clouddn.com/javase20_13.jpg)  
具体规则：  
1. 组装54张扑克牌
2. 将54张牌顺序打乱
...
![](http://p3csbnxye.bkt.clouddn.com/javase20_14.jpg) 	

#### 2.3 实现代码步骤

![](http://p3csbnxye.bkt.clouddn.com/javase20_15.jpg) 
